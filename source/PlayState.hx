...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Practica para ser mejor', 0.2], //From 0% to 19%
		['Mierda', 0.4], //From 20% to 39%
		['Malisimo F', 0.5], //From 40% to 49%
		['Bruh', 0.6], //From 50% to 59%
		['Meme memememe >:(', 0.69], //From 60% to 68%
		['Muy nice', 0.7], //69%
		['Buenisimo', 0.8], //From 70% to 79%
		['Buen trabajo', 0.9], //From 80% to 89%
